...
var IPCC_WEBCHAT_SETTINGS = {
    server:         '//5.9.80.44:8882', //адрес и HTTP порт ipcc сервера
    ...
    chatBox:        true, //создать встроенный чат
    regPanel:       true, //создать панель заполнения данных
    logoSrc:        '/IPCCWebchat/ipcc/webchat/logo.png', //путь к файлу с логотипом
